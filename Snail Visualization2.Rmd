...
average1 %>% ggplot(aes(x = factor(Date, levels = level_order), y = Mean)) + geom_point(aes(x = factor(Date, levels = level_order), y = Mean)) + geom_errorbar(aes(ymin=Mean-SE, ymax=Mean+SE)) + theme_bw() + theme(text = element_text(size = 9), axis.text.x = element_text(angle = 40, vjust = 0.85), axis.ticks = element_blank()) + xlab('Date') + ylab('Littoraria Density (m2)') + ggtitle('LUM1')

average2 %>% ggplot(aes(x = factor(Date, levels = level_order), y = Mean)) + geom_point(aes(x = factor(Date, levels = level_order), y = Mean)) + geom_errorbar(aes(ymin=Mean-SE, ymax=Mean+SE)) + theme_bw() + theme(text = element_text(size = 9), axis.text.x = element_text(angle = 45, vjust = 0.85), axis.ticks = element_blank()) + xlab('Date') + ylab('Littoraria Density (m2)') + ggtitle('LUM2')

average3 %>% ggplot(aes(x = factor(Date, levels = level_order), y = Mean)) + geom_point(aes(x = factor(Date, levels = level_order), y = Mean)) + geom_errorbar(aes(ymin=Mean-SE, ymax=Mean+SE)) + theme_bw() + theme(text = element_text(size = 9), axis.text.x = element_text(angle = 45, vjust = 0.85), axis.ticks = element_blank()) + xlab('Date') + ylab('Littoraria Density (m2)') + ggtitle('LUM3')
```
...
```{r}
snailnew %>% ggplot(aes(x = Date, y = proplit)) + geom_point(aes(x = Date, y = proplit)) + geom_errorbar(aes(ymin = proplit-proplitSE, ymax = proplit+proplitSE)) + geom_smooth(method = 'lm') + theme_bw() + ylab('Percent') + ggtitle('Percent Littoraria')

snailnew %>% ggplot(aes(x = Date, y = propner)) + geom_point(aes(x = Date, y = propner)) + geom_errorbar(aes(ymin = propner-propnerSE, ymax = propner+propnerSE)) + geom_smooth(method = 'lm') + theme_bw() + ylab('Percent') + ggtitle('Percent N. usnea')
```
