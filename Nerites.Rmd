...
snail1.17 <- snail1 %>% subset(year == '2017') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail1.17 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM1 Nerite Density in 2017')
...
snail1.18 <- snail1 %>% subset(year == '2018') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail1.18 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM1 Nerite Density in 2018')
...
snail1.19 <- snail1 %>% subset(year == '2019') %>%
  ...
  summarise(mean = mean(Nu_density_m2), 
            SE = std.error(Nu_density_m2))
snail1.19 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM1 Nerite Density in 2019')
...
snail1.20 <- snail1 %>% subset(year == '2020') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail1.20 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM1 Nerite Density in 2020')
...
snail1.21 <- snail1 %>% subset(year == '2021') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail1.21 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM1 Nerite Density in 2021')
```
...
snail2.17 <- snail2 %>% subset(year == '2017') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail2.17 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM2 Nerite Density in 2017')
...
snail2.18 <- snail2 %>% subset(year == '2018') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail2.18 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM2 Nerite Density in 2018')
...
snail2.19 <- snail2 %>% subset(year == '2019') %>%
  ...
  summarise(mean = mean(Nu_density_m2), 
            SE = std.error(Nu_density_m2))
snail2.19 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM2 Nerite Density in 2019')
...
snail2.20 <- snail2 %>% subset(year == '2020') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail2.20 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM2 Nerite Density in 2020')
...
snail2.21 <- snail2 %>% subset(year == '2021') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail2.21 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM2 Nerite Density in 2021')
```
...
snail3.17 <- snail3 %>% subset(year == '2017') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail3.17 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM3 Nerite Density in 2017')
...
snail3.18 <- snail3 %>% subset(year == '2018') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail3.18 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM3 Nerite Density in 2018')
...
snail3.19 <- snail3 %>% subset(year == '2019') %>%
  ...
  summarise(mean = mean(Nu_density_m2), 
            SE = std.error(Nu_density_m2))
snail3.19 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM3 Nerite Density in 2019')
...
snail3.20 <- snail3 %>% subset(year == '2020') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail3.20 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM3 Nerite Density in 2020')
...
snail3.21 <- snail3 %>% subset(year == '2021') %>%
  ...
  summarise(mean = mean(Nu_density_m2),
            SE = std.error(Nu_density_m2))
snail3.21 %>% ggplot(aes(x=month_name, y=mean)) + geom_point(aes(x=month_name, y=mean)) + geom_errorbar(aes(ymin = mean-SE, ymax = mean+SE)) + xlab('Month') + ylab('Nerite Density') + ggtitle('LUM3 Nerite Density in 2021')
```
