...
#34
sum(with(nerdays2,Year == "2021"))
#0
```

#looking at entire study period
```{r}
#this is how to specify which x intervals to label- lebels according to month names at those breaks
