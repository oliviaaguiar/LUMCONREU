...
plot(combined1$study_month, combined1$average_lit, pch = 16, col = 2, xlab = 'Study Month', ylab = 'Littoraria Density', main = 'LUM1')
par(new = TRUE)                           
plot(combined1$study_month, combined1$average_Chla, pch = 17, col = 3,
...
```{r}
par(mar = c(5, 4, 4, 4) + 0.3)
plot(combined2$study_month, combined2$average_lit, pch = 16, col = 2, xlab = 'Study Month', ylab = 'Littoraria Density', main = 'LUM2')
par(new = TRUE)                           
plot(combined2$study_month, combined2$average_Chla, pch = 17, col = 3,
     axes = FALSE, xlab = "", ylab = "")
...
```{r}
par(mar = c(5, 4, 4, 4) + 0.3)
plot(combined3$study_month, combined3$average_lit, pch = 16, col = 2, xlab = 'Study Month', ylab = 'Littoraria Density', main = 'LUM3')
par(new = TRUE)                           
plot(combined3$study_month, combined3$average_Chla, pch = 17, col = 3,
     axes = FALSE, xlab = "", ylab = "")
